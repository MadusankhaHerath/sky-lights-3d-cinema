...
const AdminLayout =({children}) =>{
    ...
    const siderItems = [{value:"dashboard", label:"Dashboard",path:"/Admin/Dashboard"},
    ...
    {/* Sidebar */}
            <aside className="w-64 bg-blue-900 text-white flex flex-col h-full ">
                        ...
                        <nav className="flex-1 p-2 h-full " >
                        {siderItems.map(
                            (item, index) => (
                            <Link
                                key={index}
                                ...
                                //onClick={() => setSelectedSiderItems(item.value)} 
                            >
                                {item.label}
                            </Link>
                            )
            ...
            {/* Footer */}
        <footer className=" bg-blue-200 p-4 h-full" >
            <div className="flex justify-between h-[full]">
                {/* Social Icons */}
                <div className="flex space-x-3">
                <a href="#" className="text-black text-xl">🅿️</a>
                <a href="#" className="text-black text-xl">𝕏</a>
